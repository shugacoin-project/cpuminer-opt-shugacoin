...
const char * LIB_PATH_VALUE   = "Z:\\home\\ak\\git\\cpuminer-opt-shugacoin\\depends\\curl-7.47.0\\lib\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "Z:\\home\\ak\\git\\cpuminer-opt-shugacoin\\depends\\curl-7.47.0\\lib\\.libs;Z:\\usr\\local\\lib;Z:\\usr\\local\\bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    PATH=/home/ak/git/cpuminer-opt-shugacoin/depends/curl-7.47.0/lib/.libs:/us", f);
  fputs ("r/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/home/ak/git/cpuminer-opt-shugacoin/depends/curl-7.47.0/lib/.libs:$P", f);
  fputs ("ATH\"\n", f);
  fputs ("\n", f);
