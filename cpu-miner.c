...
static void show_credits()
{
    ...
    if ( use_colors ) {
        printf("     BTC donation: "CL_CYN"bc1qha3e7mzckctq0ejh3z5gvzes8jftj04j96gjfl"CL_N" (dev shugacoin)\n");
        printf("     SHUGA donation: "CL_CYN"shuga1q8mpwgsk0zjr30a7xxhftt7wn9scsav9cpsdwgl"CL_N" (dev shugacoin)\n\n");
    } else {
        printf("     BTC donation address: bc1qha3e7mzckctq0ejh3z5gvzes8jftj04j96gjfl (dev shugacoin)\n");
        printf("     SHUGA donation: shuga1q8mpwgsk0zjr30a7xxhftt7wn9scsav9cpsdwgl (dev shugacoin)\n\n");
    }
}
